...
public class AribTools {
	...
	/**
	 * Generates Roadside-to-Vehicle period information details related to the count of base stations in the system.
	 * 
	 * @param baseStationCount
	 */
	private static void generateRvcPeriods(int baseStationCount) {
		System.out.println("\nCalculating Roadside-to-Vehicle period information details for " + baseStationCount + " base station(s) in the system.");
		...
		for (int i = 0; i < _PeriodCount; i++) {
			...
			for (int j = 0; j < baseStationCount; j++) {
				...
				// the transmission period begin is relative to the Roadside-to-Vehicle period begin. Hence, it's value has to be between 0 (inclusive) and the Roadside-to-Vehicle period duration (inclusive).
	...
	private static void printHelp() {
		sb.append("\nTools for ARIB T109 by Julian Heinovski (mail@julian-heinovski.de). 2015.\n\nThese tools provide some functionality which will come in handy while working with the ARIB T109 communication standard for intelligient transport systems.\n"); // TODO add description
		sb.append("\n\n");
